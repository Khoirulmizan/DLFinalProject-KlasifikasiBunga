# File: informasi_bunga.py
#
# Pusat data yang menghubungkan ID (nama folder) dengan informasi bunga.
# Indentasi telah diperbaiki.
...
DATA_BUNGA = {
    ...
    "bunga3": {
        ...
        "jenis": "Tanaman Semak",
        "deskripsi": "Kencana adalah tanaman hias yang sangat populer karena ketahanannya dan kemampuannya berbunga sepanjang tahun, terutama di iklim tropis. Bunganya berbentuk terompet dengan warna ungu cerah yang mencolok (ada varian berwarna ungu, putih atau merah muda pucat). Daunnya panjang, sempit, dan berwarna hijau tua, seringkali dengan batang yang juga berwarna keunguan. Tanaman ini sangat mudah tumbuh dan sering dianggap sebagai gulma atau tanaman invasif di beberapa daerah karena kemampuannya menyebar dengan cepat, baik melalui biji (yang meletup) maupun rimpang (akar)."
    },
    "bunga4": {
        "nama_umum": "Bunga Tabebuya, Pohon Terompet Emas",
        "nama_latin": "Handroanthus chrysotrichus",
        "kerabat": "Acaranda dan Bunga Api",
        "jenis": "Pohon",
    ...
    "bunga10": {
        ...
        "jenis": "Tanaman Semak Hias",
        "deskripsi": "Tanaman perdu dengan bunga berwarna putih bersih yang seringkali wangi, terutama di malam hari. Kelopak bunganya sering terlihat tumpang tindih dan memutar seperti kincir angin. Tanaman ini mengeluarkan getah berwarna putih susu jika batangnya dipatahkan."
    },
    "bunga11": {
        "nama_umum": "Kembang Kertas",
        "nama_latin": "Zinnia Elegans",
        "kerabat": "Bunga Matahari, Krisan, Marigold, Dahlia",
        "jenis": "Tanaman Hias",
        "deskripsi": "Bunga ini berasal dari Meksiko dan populer sebagai tanaman hias karena warnanya yang beragam dan bentuk bunganya yang indah, dengan kelopak yang kaku mirip kertas. Selain sebagai tanaman hias, bunga ini juga digunakan untuk berbagai keperluan lain, seperti diolah menjadi teh herbal, dan mengandung senyawa bioaktif."
    },
    "bunga12": {
        "nama_umum": "Bunga Pukul Sembilan",
        "nama_latin": "Portulaca grandiflora",
        "kerabat": "Bunga Krokot Biasa, Purslane Kuning, Purslane Semak, Silkcotton Purslane",
    ...
    "bunga13": {
        ...
        "jenis": "Tanaman Hias",
        "deskripsi": "Bunga ini merupakan bunga kecil yang mekar sepanjang tahun dan memiliki warna ungu atau putih, meskipun ada variasi lain seperti merah muda dan kuning. Bunga ini mudah dirawat, tahan panas, dan sering digunakan sebagai tanaman hias, pembatas taman, atau topiary karena pertumbuhannya yang rapi."
    },
    "bunga14": {
        "nama_umum": "Bunga Madia",
        "nama_latin": "Thunbergia grandiflora",
        "kerabat": "Akar Ketuau, Thunbergia mata-hitam, Bunga Kencana",
        "jenis": "Tanaman Hias",
    ...
    "bunga16": {
        ...
        "deskripsi": "Bunga ini memiliki rasa sangat pahit karena kandungan senyawa quassin, digunakan sebagai obat tradisional, penambah nafsu makan, antiparasit, insektisida alami, dan dapat diseduh seperti teh herbal."
    },
    "bunga17": {
        "nama_umum": "Bunga Tahi Ayam",
        "nama_latin": "Lantana camara",
        "kerabat": "Verbena, Legundi",
        "jenis": "Tanaman Hias, Herbal",
        "deskripsi": "Tanaman ini populer sebagai tanaman hias, pagar, dan tanaman penarik serangga seperti kupu-kupu dan lebah karena nektarnya yang manis. Selain keindahannya, tanaman ini juga memiliki manfaat tradisional sebagai obat herbal dan sifat antimikroba, insektisida, serta fungisida alami."
    },
    "bunga18": {
        "nama_umum": "Bunga Kincir Angin",
        "nama_latin": "Tabernaemontana divaricata",
        "kerabat": "Bunga Manila, Bunga Kamboja, Oleander",
        "jenis": "Tanaman Hias",
        "deskripsi": "Tanaman ini memiliki potensi manfaat dalam bidang industri obat, seperti untuk luka, iritasi mata, batuk, serta sebagai antiinflamasi dan antioksidan. Semua bagian tanaman, termasuk getah putih susu yang keluar saat dipotong, bersifat racun bagi manusia dan hewan peliharaan, sehingga perlu hati-hati dalam penanganan."
    },
    "bunga19": {
        "nama_umum": "Bunga Air Mancur",
        "nama_latin": "Russelia equisetiformis",
        "kerabat": "Mulut Naga, Foxglove, Angelonia",
        "jenis": "Tanaman Hias",
        "deskripsi": "Bunga ini sering disebut bunga air mancur atau bunga petasan karena bentuknya yang unik dan menjuntai seperti percikan air atau api. Bunga ini juga menarik serangga penyerbuk dan burung nektar, menjadikan tanaman ini pilihan dekoratif sekaligus fungsional di taman tropis maupun subtropis."
    },
    "bunga20": {
        "nama_umum": "Bunga Kertas",
        "nama_latin": "Bougainvillea",
        "kerabat": "Bunga Pukul Empat, Kol Banda, Abronia",
        "jenis": "Tanaman Hias",
        "deskripsi": "Tanaman ini berfungsi sebagai tanaman penyerap polusi udara dan memiliki fungsi arsitektural seperti pembatas ruang. Selain itu, tanaman ini juga mengandung senyawa antioksidan seperti flavonoid, alkaloid, dan saponin, yang bermanfaat untuk melawan inflamasi, menjaga keseimbangan kolesterol, mengontrol gula darah, dan membantu menyembuhkan luka."
    },
    "bunga21": {
        "nama_umum": "Bunga Rosella",
        "nama_latin": "Hibiscus sabdariffa",
